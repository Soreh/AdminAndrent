...
import { DayRentalInfos, DayRow } from "../../../pages/rental-module/rental-calendar/rental-calendar";
...
export class CalendarServiceProvider {
  ...
  async addDate(day: DayRow, year: number, month: number) {
    this.setDaysList(year, month);
  ...
  private setDaysList(year: number, month: number): void {
